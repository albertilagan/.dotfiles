vim.cmd [[
  ...
  command! CloseBuffer lua require('albertilagan.config.autocmds').close_buffer()
  command! ForceCloseBuffer lua require('albertilagan.config.autocmds').force_close_buffer()
]]
